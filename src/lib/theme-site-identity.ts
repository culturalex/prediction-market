...
import { DEFAULT_SITE_LOGO_SVG_SOURCE } from '@/lib/site-logo-asset'
...
const DEFAULT_SITE_NAME_FALLBACK = 'Cultural Exchange'
const DEFAULT_SITE_DESCRIPTION_FALLBACK = 'Decentralized Prediction Markets'
const DEFAULT_SITE_LOGO_SVG_FALLBACK = DEFAULT_SITE_LOGO_SVG_SOURCE
